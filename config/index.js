export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx979b571a647ea255",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "1c54263bfeafff3246bd429c2a013cb9",
   ...
   */
  USERS: [o5JN75g6wxn08yiqB8qO4JRQdD7w]
    {
      // 想要发送的人的名字
      name: "老婆0",
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "XgoFCj_ABc9eziYYzseFjwtVZ0pByQZ3H3C-Jo9M0pE",
      // 所在省份
      province: "浙江",
      // 所在城市
      city: "温州",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2004", "date": "03-18"},
        {"type": "节日", "name": "恋爱日", "year": "2022", "date": "07-10"},
  ...
  CALLBACK_USERS: [o5JN75nTySyPYAfJMWw_EC2_2Log]
    {
      // 一般都填自己
      name: "自己",
